...
bot.on('ready', () => {
    ...
    setTimeout(function(){
        ...
        bot.channels.get("548471315200475137").send("Pour avoir les rôles correspondants aux Battle Royales auxquels vous jouez, il suffit de cliquer sur les logos des jeux !").then(async function (message) {
            ...
            await bot.channels.get("548471315200475137").send("!removerolesbot");
        });
...
bot.on('message', message => {
    ...
    if(message.content === prefix + "removerolesbot") {
        ...
        let APEX = message.guild.roles.find("name", "Apex Legends");
        let FORTNITE = message.guild.roles.find("name", "Fortnite");
        let PUBG = message.guild.roles.find("name", "PUBG");
        let REALM = message.guild.roles.find("name", "Realm Royale");
        let RING = message.guild.roles.find("name", "Ring of Elysium");
        member.removeRole(APEX);
        member.removeRole(FORTNITE);
        member.removeRole(PUBG);
        member.removeRole(REALM);
        member.removeRole(RING);
        console.log("Les rôles du bot ont étés enlevés !")
    }
...
bot.on('messageReactionAdd', (reaction, user) => {
    ...
    if (message.content === "Pour avoir les rôles correspondants aux Battle Royales auxquels vous jouez, il suffit de cliquer sur les logos des jeux !"){
