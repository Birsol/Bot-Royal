...
bot.on('message', message => {
    ...
    if (message.content.toUpperCase().includes('HTTPS://')) {
        if (message.member.roles.find("name", "Modérateur") || (message.member.roles.find("name", "Bot Royal"))) {
            return;
        }
        message.delete()
    ...
    if (message.content === prefix + "stats"){
        if(message.channel.id === '548510389487271954') {
            message.reply("merci de préciser un argument : !stats <FORTNITE/PUBG/REALM ROYALE> <PC/XBOX/PS4/SWITCH> (si Fortnite: <BR/SLM>)");
        } else {
            message.delete();
            message.reply("Tu dois être dans le salon #🤖commandes pour pouvoir exécuter cette commande !");
            return;
    ...
    if (message.toUpperCase.content === prefix + "stats FORTNITE PC"){
        if(message.channel.id === '548510389487271954') {
    ...
    if (message.toUpperCase.content === prefix + "stats FORTNITE XBOX"){
        if(message.channel.id === '548510389487271954') {
            message.reply("Tes statistiques sur le mode Battle Royale de Fortnite t'on été envoyées en messages privés !");
            message.author.send(`:warning: **Vérifiez que votre pseudo Discord soit le même qu'en jeu !** :warning:\n \nPour voir tes statistiques sur le mode Battle Royale, clique sur ce lien :\n https://www.stormshield.one/pvp/stats/${message.author.username}`);
        } else {
    ...
    if (message.toUpperCase.content === prefix + "stats FORTNITE PS4"){
        if(message.channel.id === '548510389487271954') {
            message.reply("Tes statistiques sur le mode Battle Royale de Fortnite t'on été envoyées en messages privés !");
            message.author.send(`:warning: **Vérifiez que votre pseudo Discord soit le même qu'en jeu !** :warning:\n \nPour voir tes statistiques sur le mode Battle Royale, clique sur ce lien :\n https://www.stormshield.one/pvp/stats/${message.author.username}`);
        } else {
    ...
    if (message.toUpperCase.content === prefix + "stats FORTNITE SWITCH"){
        if(message.channel.id === '548510389487271954') {
            message.reply("Tes statistiques sur le mode Battle Royale de Fortnite t'on été envoyées en messages privés !");
            message.author.send(`:warning: **Vérifiez que votre pseudo Discord soit le même qu'en jeu !** :warning:\n \nPour voir tes statistiques sur le mode Battle Royale, clique sur ce lien :\n https://www.stormshield.one/pvp/stats/${message.author.username}`);
        } else {
    ...
    if (message.toUpperCase.content === prefix + "stats REALM ROYALE PC"){
        if(message.channel.id === '548510389487271954') {
    ...
    if (message.toUpperCase.content === prefix + "stats REALM ROYALE XBOX"){
        if(message.channel.id === '548510389487271954') {
            message.reply("Tes statistiques sur le jeu Realm Royale t'on été envoyées en messages privés !");
    ...
    if (message.toUpperCase.content === prefix + "stats REALM ROYALE PS4"){
        if(message.channel.id === '548510389487271954') {
            message.reply("Tes statistiques sur le jeu Realm Royale t'on été envoyées en messages privés !");
    ...
    if (message.toUpperCase.startsWith == prefix + "stats PUBG"){
        if(message.channel.id === '548510389487271954') {
            message.reply("Tes statistiques sur le jeu Realm Royale t'on été envoyées en messages privés !");
    ...
    if (message.toUpperCase.content === prefix + "stats APEX LEGENDS PC"){
        if(message.channel.id === '548510389487271954') {
            message.reply("Tes statistiques sur le jeu Realm Royale t'on été envoyées en messages privés !");
    ...
    if (message.toUpperCase.content === prefix + "stats APEX LEGENDS XBOX"){
        if(message.channel.id === '548510389487271954') {
            message.reply("Tes statistiques sur le jeu Realm Royale t'on été envoyées en messages privés !");
    ...
    if (message.toUpperCase.content === prefix + "stats APEX LEGENDS PS4"){
        if(message.channel.id === '548510389487271954') {
            message.reply("Tes statistiques sur le jeu Realm Royale t'on été envoyées en messages privés !");
    ...
    if (message.content === prefix + "help"){
        ...
        var help_embed = new Discord.RichEmbed()
            .setColor('#FFFFFF')
            .addField("Mes commandes :", "   - !help : Affiche mes commandes disponibles\n - !stats <FORTNITE/PUBG/REALM ROYALE> <PC/XBOX/PS4/SWITCH> (si Fortnite: <BR/SLM>) : Exécutez cette commande pour avoir vos statistiques sur les différents jeux proposés.\n- !membercount : Cette commande permet de voir les informations du serveur Discord.")
