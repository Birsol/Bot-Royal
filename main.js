...
bot.on('message', message => {
    ...
    if (message.content.toUpperCase === prefix + "stats FORTNITE PC"){
        if(message.channel.id === '548510389487271954') {
    ...
    if (message.content.toUpperCase === prefix + "stats FORTNITE XBOX"){
        if(message.channel.id === '548510389487271954') {
            message.reply("Tes statistiques sur le mode Battle Royale de Fortnite t'on été envoyées en messages privés !");
            message.author.send(`:warning: **Vérifiez que votre pseudo Discord soit le même qu'en jeu !** :warning:\n \nPour voir tes statistiques sur le mode Battle Royale, clique sur ce lien :\n https://www.stormshield.one/pvp/stats/${message.author.username}`);
        } else {
    ...
    if (message.content.toUpperCase === prefix + "stats FORTNITE PS4"){
        if(message.channel.id === '548510389487271954') {
            message.reply("Tes statistiques sur le mode Battle Royale de Fortnite t'on été envoyées en messages privés !");
            message.author.send(`:warning: **Vérifiez que votre pseudo Discord soit le même qu'en jeu !** :warning:\n \nPour voir tes statistiques sur le mode Battle Royale, clique sur ce lien :\n https://www.stormshield.one/pvp/stats/${message.author.username}`);
        } else {
    ...
    if (message.content.toUpperCase === prefix + "stats FORTNITE SWITCH"){
        if(message.channel.id === '548510389487271954') {
            message.reply("Tes statistiques sur le mode Battle Royale de Fortnite t'on été envoyées en messages privés !");
            message.author.send(`:warning: **Vérifiez que votre pseudo Discord soit le même qu'en jeu !** :warning:\n \nPour voir tes statistiques sur le mode Battle Royale, clique sur ce lien :\n https://www.stormshield.one/pvp/stats/${message.author.username}`);
        } else {
    ...
    if (message.content.toUpperCase === prefix + "stats REALM PC"){
        if(message.channel.id === '548510389487271954') {
    ...
    if (message.content.toUpperCase === prefix + "stats REALM XBOX"){
        if(message.channel.id === '548510389487271954') {
            message.reply("Tes statistiques sur le jeu Realm Royale t'on été envoyées en messages privés !");
    ...
    if (message.content.toUpperCase === prefix + "stats REALM PS4"){
        if(message.channel.id === '548510389487271954') {
            message.reply("Tes statistiques sur le jeu Realm Royale t'on été envoyées en messages privés !");
    ...
    if (message.content.toUpperCase === prefix + "stats APEX PC"){
        if(message.channel.id === '548510389487271954') {
            message.reply("Tes statistiques sur le jeu Realm Royale t'on été envoyées en messages privés !");
    ...
    if (message.content.toUpperCase === prefix + "stats APEX XBOX"){
        if(message.channel.id === '548510389487271954') {
            message.reply("Tes statistiques sur le jeu Realm Royale t'on été envoyées en messages privés !");
    ...
    if (message.content.toUpperCase === prefix + "stats APEX PS4"){
        if(message.channel.id === '548510389487271954') {
            message.reply("Tes statistiques sur le jeu Realm Royale t'on été envoyées en messages privés !");
