...
bot.on('message', message => {
    ...
    if (message.content.toUpperCase().includes('HTTPS://')) {
        if(message.content.startsWith(":warning: **Vérifiez que votre pseudo Discord soit le même qu'en jeu !** :warning:")) {
            return;
        }
    ...
    if (message.content === prefix + "stats"){
        if(message.channel.id === '548510389487271954') {
            message.reply("merci de préciser un argument : !stats <APEX/FORTNITE/PUBG/REALM> <PC/XBOX/PS4/SWITCH>");
        } else {
            message.delete();
            message.reply("Tu dois être dans le salon #🤖commandes pour pouvoir exécuter cette commande !");
            return;
    ...
    if (message.content === prefix + "stats FORTNITE PC"){
        if(message.channel.id === '548510389487271954') {
            message.reply("Tes statistiques sur Fortnite t'on été envoyées en messages privés !");
    ...
    if (message.content === prefix + "stats FORTNITE XBOX"){
        if(message.channel.id === '548510389487271954') {
            message.reply("Tes statistiques sur Fortnite t'on été envoyées en messages privés !");
            message.author.send(`:warning: **Vérifiez que votre pseudo Discord soit le même qu'en jeu !** :warning:\n \nPour voir tes statistiques sur le mode Battle Royale, clique sur ce lien :\n https://www.stormshield.one/pvp/stats/${message.author.username}`);
        } else {
    ...
    if (message.content === prefix + "stats FORTNITE PS4"){
        if(message.channel.id === '548510389487271954') {
            message.reply("Tes statistiques sur Fortnite t'on été envoyées en messages privés !");
            message.author.send(`:warning: **Vérifiez que votre pseudo Discord soit le même qu'en jeu !** :warning:\n \nPour voir tes statistiques sur le mode Battle Royale, clique sur ce lien :\n https://www.stormshield.one/pvp/stats/${message.author.username}`);
        } else {
    ...
    if (message.content === prefix + "stats FORTNITE SWITCH"){
        if(message.channel.id === '548510389487271954') {
            message.reply("Tes statistiques sur Fortnite t'on été envoyées en messages privés !");
            message.author.send(`:warning: **Vérifiez que votre pseudo Discord soit le même qu'en jeu !** :warning:\n \nPour voir tes statistiques sur le mode Battle Royale, clique sur ce lien :\n https://www.stormshield.one/pvp/stats/${message.author.username}`);
        } else {
    ...
    if (message.content === prefix + "stats REALM PC"){
        if(message.channel.id === '548510389487271954') {
            message.reply("Tes statistiques sur Realm Royale t'on été envoyées en messages privés !");
    ...
    if (message.content === prefix + "stats REALM XBOX"){
        if(message.channel.id === '548510389487271954') {
            message.reply("Tes statistiques sur Realm Royale t'on été envoyées en messages privés !");
    ...
    if (message.content === prefix + "stats REALM PS4"){
        if(message.channel.id === '548510389487271954') {
            message.reply("Tes statistiques sur Realm Royale t'on été envoyées en messages privés !");
    ...
    if (message.content.startsWith(prefix + "stats PUBG")){
        if(message.channel.id === '548510389487271954') {
            message.reply("Tes statistiques sur PUBG t'on été envoyées en messages privés !");
            message.author.send(`:warning: **Vérifiez que votre pseudo Discord soit le même qu'en jeu !** :warning:\n \nPour voir tes statistiques sur PUBG, clique sur ce lien :\n https://pubg.op.gg/user/${message.author.username}`);
        } else {
            message.delete();
            message.reply("Tu dois être dans le salon #🤖commandes pour pouvoir exécuter cette commande !");
            return;
    ...
    if (message.content === prefix + "stats APEX PC"){
        if(message.channel.id === '548510389487271954') {
            message.reply("Tes statistiques sur Apex Legends t'on été envoyées en messages privés !");
            message.author.send(`:warning: **Vérifiez que votre pseudo Discord soit le même qu'en jeu !** :warning:\n \nPour voir tes statistiques sur Apex Legends, clique sur ce lien :\n https://apex.tracker.gg/profile/pc/${message.author.username}`);
        } else {
            message.delete();
            message.reply("Tu dois être dans le salon #🤖commandes pour pouvoir exécuter cette commande !");
            return;
    ...
    if (message.content === prefix + "stats APEX XBOX"){
        if(message.channel.id === '548510389487271954') {
            message.reply("Tes statistiques sur Apex Legends t'on été envoyées en messages privés !");
            message.author.send(`:warning: **Vérifiez que votre pseudo Discord soit le même qu'en jeu !** :warning:\n \nPour voir tes statistiques sur Apex Legends, clique sur ce lien :\n https://apex.tracker.gg/profile/xbox/${message.author.username}`);
        } else {
            message.delete();
            message.reply("Tu dois être dans le salon #🤖commandes pour pouvoir exécuter cette commande !");
            return;
    ...
    if (message.content === prefix + "stats APEX PS4"){
        if(message.channel.id === '548510389487271954') {
            message.reply("Tes statistiques sur Apex Legends t'on été envoyées en messages privés !");
            message.author.send(`:warning: **Vérifiez que votre pseudo Discord soit le même qu'en jeu !** :warning:\n \nPour voir tes statistiques sur Apex Legends, clique sur ce lien :\n https://apex.tracker.gg/profile/ps/${message.author.username}`);
        } else {
            message.delete();
            message.reply("Tu dois être dans le salon #🤖commandes pour pouvoir exécuter cette commande !");
            return;
